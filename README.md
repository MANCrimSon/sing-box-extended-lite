...
[![License](https://img.shields.io/github/license/MANCrimSon/sing-box-extended-lite)](LICENSE)
...
| Arch | Target OpenWrt | Examples |
| :--- | :--- | :--- |
| **`arm64`** | `aarch64_cortex-a53` | Xiaomi AX3000T, Keenetic Hopper/Titan, TUF AX4200, Filogic 820 |
| **`amd64`** | `x86_64` | Mini PCs, x86 routers, Proxmox / ESXi VMs |
| **`mipsle-softfloat`** | `mipsel_24kc` | MediaTek MT7621 (Keenetic Hero/Giga, Xiaomi AC2100) |
| **`mips-softfloat`** | `mips_24kc` | Qualcomm / Atheros classic routers |
| **`armv7`** | `arm_cortex-a7` | 32-bit ARM routers (Cortex-A7 / Cortex-A15) |

---

## 🔍 Commands & Verification

Check version and service status on OpenWrt:
```sh
sing-box version
